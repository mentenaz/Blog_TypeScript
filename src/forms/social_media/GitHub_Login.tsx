...
const GitHubLogin: React.FC<SocialMediaLoginProps> = ({showToast, setLoginInfo, setError}) => {
	const handleGitHubLogin = async () => {
		...
		try {
			...
			console.log("Successfully signed in with GitHub:", signedInUser);
			...
			setError(null);
			showToast("Successfully signed in with GitHub.", true);
		} catch (error: any) {
			setError(error.message);
			console.error("Error signing in with GitHub:", error);
			showToast("Error signing in with GitHub.", false);
		}
	};
